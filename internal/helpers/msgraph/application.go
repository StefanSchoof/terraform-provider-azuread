...
func ApplicationFlattenAppRoles(in *[]models.ApplicationAppRole) []map[string]interface{} {
	if in == nil {
...
func AppRoleFindById(app *models.Application, roleId string) (*models.ApplicationAppRole, error) {
